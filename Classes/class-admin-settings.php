...
function remixcomp_settings() {
    ...
    if($_POST['check_post'] == "true") {
        ...
        $ken_settings = array(
            ...
            'kenrmx_twitter_via_user' => $_POST['kenrmx_twitter_via_user'],
            'kenrmx_license_code' => base64_encode($_POST['kenrmx_license_code'])
        );
       ...
       <div class="tab">
        ...
        <div class="tab">
           ...
           <div class="content">
            ...
            <div style="color:#999;"><?php _e('Twitter via user @','soundcloud-sound-competition'); ?>:</div>
            <input type="text" title="Twitter via user @" size="60" name="kenrmx_twitter_via_user" value="<?php echo $kenrmx_twitter_via_user; ?>"/><br><br>
            <input id="submit" class="button button-primary" type="submit" value="Save Changes" name="submit"></input>
            </p>
           </div> 
       </div>
        ...
        <div class="tab">
           ...
           <label for="tab-5"><strong><?php _e('License','soundcloud-sound-competition'); ?></strong></label>
         
           <div class="content">
            <p>    
            <h3><?php _e('License Key','soundcloud-sound-competition'); ?></h3>
            <?php if( soundcloud_sound_competition_ch_l() ){ ?>
            <div style="color:green;"><?php _e('Valid License Key','soundcloud-sound-competition'); ?></div>
            <?php }else{ ?>
            <div style="color:#999;"><?php _e('Please enter your license key','soundcloud-sound-competition'); ?>:</div>
            <?php } ?>
            <input type="text" title="license" size="60" name="kenrmx_license_code" value="<?php if(soundcloud_sound_competition_ch_l()){echo('****-****-****');}?>"/><br><br>
            <input id="submit" class="button button-primary" type="submit" value="Save Changes" name="submit"></input>
