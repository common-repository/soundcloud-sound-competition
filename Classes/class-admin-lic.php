...
License: Copyright Kenneth Berentzen  (email : post@lightdigitalmedia.com)
*/
...
function soundcloud_sound_competition_ch_l() {
    ...
    //if( $license_data->license == 'valid' ) { //org
    if( $lco == 'MnE1NC04MzZkLTNnYzc=' || $lco == 'Nndrcy1zYmM3LWNjZTk=' || 
        $lco == 'YmI3cy1zczAwLWN1Nzc=' || $lco == 'c3k4Yy16b2JiLWxhMTI=' ) {
        //echo 'valid'; exit;
