...
= 1.1.0.0 =
* Fixed facebook errors.
* Bug fixes.

= 1.0.1.3 =
* Changed Soundcloud player
* Added twitter handler sharing input in settings
* Bug fixes.
